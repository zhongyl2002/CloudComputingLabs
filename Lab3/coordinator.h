...
private:
    ...
    vector<bool> participant_work;// 参与者工作队列
    ...
    void init();
    vector<int> participants_commit_ID;// 参与者commit队列
    void commid_ID_init();
    ...
    static void try_connect(coordinator* cor,int i,int clientfd, struct sockaddr_in addr_sera);
